      ...
      >
        <div style={{ maxWidth: "1400px", margin: "0 auto", padding: "0 24px" }}>
          <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", height: "70px" }}>
            {/* Logo */}
            <Link href={isAdmin ? "/admin-dashboard" : "/dashboard"} style={{ textDecoration: "none", display: "flex", alignItems: "center", gap: "12px" }}>
              <div
                style={{
                  width: "42px",
                  height: "42px",
              ...
              <div style={{ display: "flex", alignItems: "center", gap: "4px" }}>
                {links.map((link) => (
                  <Link key={link.href} href={link.href} style={{ textDecoration: "none" }}>
                    ...
                    >
                      <div style={{ color: isActive(link.href) ? "#ef4444" : hoveredItem === link.href ? "#ffffff" : "rgba(255, 255, 255, 0.5)", transition: "color 0.3s ease" }}>
                        {link.icon}
                      </div>
                      <span
                        style={{
              ...
              <div style={{ position: "relative" }}>
                ...
                >
                  ...
                  <svg
                    ...
                    strokeWidth="2"
                    style={{ transition: "transform 0.3s ease", transform: isProfileOpen ? "rotate(180deg)" : "rotate(0)" }}
                  >
                  ...
                  >
                    ...
                    <div style={{ padding: "8px" }}>
                      <Link href={isAdmin ? "/admin-dashboard" : "/dashboard/profile"} style={{ textDecoration: "none" }}>
                        ...
                        >
                          <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke={hoveredItem === "profile-link" ? "#ef4444" : "rgba(255, 255, 255, 0.5)"} strokeWidth="2">
                            <path d="M20 21v-2a4 4 0 0 0-4-4H8a4 4 0 0 0-4 4v2" />
                            <circle cx="12" cy="7" r="4" />
                          </svg>
                          <span style={{ fontSize: "13px", color: hoveredItem === "profile-link" ? "#ffffff" : "rgba(255, 255, 255, 0.7)" }}>Profile</span>
                        </div>
                      </Link>
                      ...
                      {!isAdmin && (
                        <Link href="/dashboard/settings" style={{ textDecoration: "none" }}>
                          ...
                          >
                            <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke={hoveredItem === "settings-link" ? "#ef4444" : "rgba(255, 255, 255, 0.5)"} strokeWidth="2">
                            ...
                            <span style={{ fontSize: "13px", color: hoveredItem === "settings-link" ? "#ffffff" : "rgba(255, 255, 255, 0.7)" }}>Settings</span>
                          </div>
                        </Link>
                      )}
                    </div>
                    ...
                    <div style={{ padding: "8px", borderTop: "1px solid rgba(255, 255, 255, 0.06)" }}>
                      ...
                      >
                        <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke={hoveredItem === "logout" ? "#ef4444" : "rgba(255, 255, 255, 0.5)"} strokeWidth="2">
                          <path d="M9 21H5a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h4" />
                          <polyline points="16 17 21 12 16 7" />
                          <line x1="21" y1="12" x2="9" y2="12" />
                        </svg>
                        <span style={{ fontSize: "13px", color: hoveredItem === "logout" ? "#ef4444" : "rgba(255, 255, 255, 0.7)" }}>Logout</span>
                      </button>
                    </div>
                  </div>
                )}
            ...
            <div style={{ padding: "16px", display: "flex", flexDirection: "column", gap: "4px" }}>
              {links.map((link) => (
                <Link key={link.href} href={link.href} style={{ textDecoration: "none" }}>
                  ...
                  >
                    <div style={{ color: isActive(link.href) ? "#ef4444" : "rgba(255, 255, 255, 0.5)" }}>{link.icon}</div>
                    <span style={{ fontSize: "15px", fontWeight: isActive(link.href) ? 600 : 400, color: isActive(link.href) ? "#ffffff" : "rgba(255, 255, 255, 0.7)" }}>
                      {link.label}
                    </span>
                    {isActive(link.href) && (
                      <div style={{ marginLeft: "auto", width: "6px", height: "6px", borderRadius: "50%", background: "#ef4444", boxShadow: "0 0 10px rgba(239, 68, 68, 0.5)" }} />
                    )}
                  </div>
                </Link>
              ))}
